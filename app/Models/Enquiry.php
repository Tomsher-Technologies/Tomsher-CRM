...
class Enquiry extends Model
{
    ...
    protected $fillable = [
        'enquiry_code','customer_id', 'enquiry_date', 'status', 'enquiry_source_id','source_mode','project_type_id', 'project_title','project_details', 'comments','added_by', 'updated_by','updated_at','submitted_cost', 'approved_cost', 'project_created', 'owner_id'
    ];
