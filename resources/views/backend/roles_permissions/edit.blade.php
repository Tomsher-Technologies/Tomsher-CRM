@extends('backend.layouts.app',['title' => 'Edit Role'])
        ...
        <form action="{{ route('roles.update', $role->id) }}" method="POST">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <input type="text" placeholder="{{ trans('messages.Role_Name')}}" value="{{ old('name', $role->name) }}" id="name" name="name" class="form-control form-control-sm">
                        @error('name')
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <label class="aiz-switch aiz-switch-success mb-0">
                                        <input type="checkbox" name="permissions[]" id="permission" class="form-control form-control-sm demo-sw" value="{{$value->name}}" {{ $selected }}>
