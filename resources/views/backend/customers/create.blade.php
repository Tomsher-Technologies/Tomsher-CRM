@extends('backend.layouts.app',['title' => 'Create Customers'])
    ...
    <div class="bg-white shadow-lg rounded-xl p-4">
        ...
        <form action="{{ route('customers.store') }}" method="POST" id="customerForm">
            ...
            <div class="mb-4">
                ...
                <div class="row ">
                    <div class="col-md-4 mb-1">
                        ...
                        <input type="text" class="form-control form-control-sm" id="customer_code" name="customer_code"  value="{{ $customerCode }}" readonly >
                    </div>
                    <div class="col-md-4 mb-1">
                    ...
                    <div class="col-md-4 d-flex justify-content-start align-items-center" style="height: 100px;">
                        <div class="form-check">
                            <input class="form-check-input custom-checkbox" type="checkbox" name="new_to_company" value="1" id="new_to_company">
                            <label class="form-check-label" for="new_to_company">
                                New To Company (NTC)
                            </label>
                        </div>
                    </div>
            ...
            <div class="mt-4 text-start">
                ...
                <button type="submit" class="btn btn-soft-success btn-sm" name="button" value="save_create">Save & Create Enquiry</button>
                <a href="{{ route('customers.index') }}" class="btn btn-info btn-sm" >Cancel</a>
            </div>
        </form>
