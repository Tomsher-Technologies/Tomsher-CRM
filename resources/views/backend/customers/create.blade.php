        ...
        <form action="{{ route('customers.store') }}" method="POST" id="customerForm">
            ...
            <div class="mb-4">
                ...
                <div class="row ">
                    ...
                    <div class="col-md-4 mb-1">
                        <label for="emirate" class="form-label">Emirate (If Country is Dubai)</label>
            ...
            <div class="mt-4 text-start">
                ...
                <button type="submit" class="btn btn-soft-success" name="button" value="save_create">Save & Create Enquiry</button>
