                    ...
                    <div class="payment-row mb-3 card">
                        <div class="row  card-body payment-section">
                            <div class="col-md-3 mb-1">
                                ...
                                <input type="text" name="payments[{{ $index }}][title]" class="form-control form-control-sm" placeholder="Payment Title" value="{{ $payment->payment_title }}" required>
                                @error('payments[{{ $index }}][title]')
                                    <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-3 mb-1 ">
                                ...
                                <input type="number" step="0.01" name="payments[{{ $index }}][amount]" class="form-control form-control-sm amount-input payment-amount" placeholder="Amount" value="{{ $payment->amount }}">
                            </div>
                            <div class="col-md-3 mb-1">
                                <label for="" class="form-label">Percentage </label>
                                <input type="number" step="0.01" name="payments[{{ $index }}][percentage]" class="form-control form-control-sm percentage-input payment-percentage" placeholder="Percentage" value="{{ $payment->percentage }}">
                            </div>
                            <div class="col-md-3 mb-1">
                                <label for="" class="form-label">Payment Method </label>
                                <select name="payments[{{ $index }}][method]" class="form-control form-control-sm">
                                    <option value="">Select Method</option>
                                    <option value="pdc" {{ $payment->method == 'pdc' ? 'selected' : '' }}>PDC</option>
                            ...
                            <div class="col-md-2 m-auto">
                                <button type="button" class="btn btn-danger btn-sm remove-payment">X Remove</button>
                            </div>
                        </div>
                    </div>
                @endforeach
...
@section('script')
<script>
    let paymentIndex = {{ $project->payments->count() }};
    ...
    $('#add_payment_btn').click(function() {
        ...
        <div class="payment-row mb-3  card">
            <div class="row card-body payment-section">
                ...
                <div class="col-md-3 mb-1">
                    <label for="" class="form-label">Percentage </label>
                    <input type="number" step="0.01" name="payments[${paymentIndex}][percentage]" class="form-control  form-control-smpercentage-input payment-percentage" placeholder="Percentage">
                </div>
                <div class="col-md-3 mb-1">
                    <label for="" class="form-label">Payment Method </label>
